...
////////////////////////////////////////////////////////////////////
    function devdmbootstrap3_theme_stylesheets()
    {
        ...
        wp_register_style('webfonts', get_template_directory_uri() . '/css/MyFontsWebfontsKit.css', array(), '1.0.0', 'all' );
        wp_enqueue_style( 'webfonts');
        wp_register_style('npkg_styles', get_template_directory_uri() . '/css/npkg.css', array(), '1.0.0', 'all' );
        wp_enqueue_style( 'npkg_styles');
