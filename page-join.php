    ...
    <div class="col-md-<?php devdmbootstrap3_main_content_width(); ?> dmbs-main">
        ...
        <div class="row">
          <div class="col-md-5 left">
            ...
            <form id="command" action="/manage/optin/ea?v=00111d-8csi5sULhAU8H-ptPLJlMZv5xmEfUplfNJTbrwMcSlZvOoRlf5kkJ4L2QZBbnDyi6pT7uDOmrOocI-ZcoQ%3D%3D" method="post">
            <input type="hidden" name="ref" value="http://www.newprestonkitchen.com/"/>
            ...
            <fieldset>
                ...
                <div class="visitorActions clearfix sidepadded">
                    <input name="_save" type="submit" class="btn continue" value="Continue"/>
                </div>
            </fieldset>
        ...
        <div class="safe-unsubscribe">
          <p>
             Getting it done right. New Preston Kitchen Goods, LLC uses <img src="http://img.constantcontact.com/letters/images/safe_unsubscribe_envelop.gif" width="12" height="9" border="0" alt="SafeUnsubscribe" title="SafeUnsubscribe" />
            <strong>SafeUnsubscribe&#0174;</strong> which reliably removes your email address from our lists.
           </p>
           <p>
             Note: In each email you receive, there will be a link to unsubscribe or change areas of interest. Your privacy is important to us - please read our <a href="//www.constantcontact.com/legal/privacy-statement" target="_blank">Email Privacy Policy</a>.
           </p>
        </div>
